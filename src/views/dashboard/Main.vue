      ...
      <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 mt-8">
          <div class="intro-y flex items-center h-10">
            <h2 class="text-lg font-medium truncate mr-5">รายงานประจำวัน</h2>
          ...
          <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
              <div class="report-box zoom-in">
                <div class="box p-5">
                  <div class="flex">
                    <LayersIcon class="report-box__icon text-primary" />
                    <div class="ml-auto">
                      <!-- <Tippy
                        tag="div"
                  ...
                  <div class="text-3xl font-medium leading-8 mt-6">60K</div>
                  <div class="text-base text-slate-500 mt-1">Tigger</div>
                </div>
              </div>
            </div>
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
              <div class="report-box zoom-in">
                <div class="box p-5">
                  <div class="flex">
                    <MonitorIcon class="report-box__icon text-pending" />
                    <div class="ml-auto">
                      <!-- <Tippy
                        tag="div"
            ...
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
              <div class="report-box zoom-in">
                <div class="box p-5">
                  <div class="flex">
                    <CreditCardIcon class="report-box__icon text-warning" />
                    <div class="ml-auto">
                      <!-- <Tippy
                        tag="div"
                        class="report-box__indicator bg-success cursor-pointer"
                  ...
                  <div class="text-3xl font-medium leading-8 mt-6">20K</div>
        ...
        <div class="col-span-12 lg:col-span-6 mt-8">
          <div class="intro-y block sm:flex items-center h-10">
            <h2 class="text-lg font-medium truncate mr-5">Message Queue</h2>
        ...
        <div class="col-span-12 sm:col-span-6 lg:col-span-3 mt-8">
          <div class="intro-y flex items-center h-10">
            <h2 class="text-lg font-medium truncate mr-5">Order Type</h2>
          ...
          <div class="intro-y box p-5 mt-5">
            ...
            <div class="w-52 sm:w-auto mx-auto mt-8">
              ...
              <div class="flex items-center mt-4">
                ...
                <span class="truncate">Suspend</span>
                <span class="font-medium ml-auto">33%</span>
              </div>
              <div class="flex items-center mt-4">
                <div class="w-2 h-2 bg-warning rounded-full mr-3"></div>
                <span class="truncate">Reconnect</span>
        ...
        <div class="col-span-12 sm:col-span-6 lg:col-span-3 mt-8">
          <div class="intro-y flex items-center h-10">
            <h2 class="text-lg font-medium truncate mr-5">SMS Report</h2>
            <a href="" class="ml-auto text-primary truncate">Show More</a>
          </div>
          <div class="intro-y box p-5 mt-5">
            <div class="mt-3">
        ...
        <div class="2xl:pl-6 grid grid-cols-12 gap-x-6 2xl:gap-x-0 gap-y-6">
          ...
          >
            <div class="intro-x flex items-center h-10">
              <h2 class="text-lg font-medium truncate mr-5">Topic</h2>
            </div>
            <div class="mt-5">
              <div
