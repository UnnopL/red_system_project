<template>
  <!-- BEGIN: Top Bar -->
  <div class="top-bar-boxed h-[70px] md:h-[65px] z-[51] border-b border-slate-300 mt-12 md:mt-0 -mx-3 sm:-mx-8 md:-mx-0 px-3 md:border-b-0 relative md:fixed md:inset-x-0 md:top-0 sm:px-8 md:px-10 md:pt-10 md:bg-gradient-to-b md:from-slate-100 md:to-transparent dark:md:from-darkmode-700">
    <div class="h-full flex items-center">
      <!-- BEGIN: Logo -->
      <a href="" class="logo -intro-x hidden md:flex xl:w-[180px] block">
        <img alt="บริษัท โทรคมนาคมแห่งชาติ จำกัด (มหาชน)" class="logo__image h-[45px]" src="@/assets/images/logo-main-nt.png" />
